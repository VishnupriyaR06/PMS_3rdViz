...
//           {/* ✅ Conditional: Show AddPhasePage OR Project Details */}
//           {showAddPhase ? (
//             <div className="mt-10">
//               <AddPhasePage
...
//                 className="px-6 py-3 bg-gradient-to-r from-pink-500 to-orange-400 text-white rounded-lg shadow hover:opacity-90 transition"
//               >
//                 Save Changes
//               </button>
//             </div>
...
//                 </p>
//                 <p>
//                   <strong>Priority:</strong> {form.priority || "Not set"}
//                 </p>
//                 <p>
...
//                 </p>
//                 <p>
//                   <strong>Start Date:</strong> {form.start_date}
//                 </p>
//                 <p>
//                   <strong>End Date:</strong> {form.End_date}
//                 </p>
//               </div>
