...
// import TeamDetail from "/src/Components/Admin_DashBoard_Components/TeamDetail.jsx";
...
//     axios
//       .post(`http://127.0.0.1:8000/api/get_team_details/`, formData)
//   };
...
//                   className="cursor-pointer bg-white border border-gray-200 rounded-2xl shadow-sm p-5 hover:shadow-md hover:scale-[1.02] transition"
//                 >
...
//        {selectedTeam && (
//   <TeamDetail
//     teamName={selectedTeam.name} // or selectedTeam.id depending on your data
